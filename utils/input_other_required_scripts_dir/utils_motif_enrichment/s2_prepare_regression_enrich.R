...
if (file.exists(paste0(output_dir,'/opt_all_motif_matches_mtx.qs2'))){
  message (' - opt_all_motif_matches_mtx.qs2 is existed, and we do not need to rebuild this file')
}else{
  ...
  qs2::qs_save(mat,file=paste0(output_dir,'/opt_all_motif_matches_mtx.qs2'))
}
...
message("save mtx")
qs2::qs_save(a,paste0(output_dir,'/','opt_',organ_nm,'_peak_cell_mtx.qs2'))
