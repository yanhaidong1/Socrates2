...
#if (file.exists(paste0(output_dir,'/temp_mtx.qs2'))){
  
#  a <- qs2::qs_read(paste0(output_dir,'/temp_mtx.qs2'))
  
#}else{
  
soc_obj <- qs2::qs_read(input_soc_obj_fl)
...
#qs2::qs_save(a,paste0(output_dir,'/temp_mtx.qs2'))
...
#                        var = apply(a, 1, var))
#qs2::qs_save(gene_attr,paste0(output_dir,'/temp_gene_attr.qs2'))
...
#qs2::qs_save(norm, paste0(output_dir,'/temp_norm.qs2'))
...
#qs2::qs_save(norm, file = paste0(output_dir,'/opt_gene_body_accessibility_mtx.qs2'))
