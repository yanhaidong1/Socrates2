...
##and save the temp files to run MACS2 for different threshold
...
def main(argv=None):
    ...
    if s3_open_filter_peak_final == 'yes':
        ...
        s3_fpeak.FDR_filteration(output_dir + '/s2_open_call_peak_final_dir', input_required_scripts_dir,
